    ...
    <div className="container mx-auto px-4 h-full flex items-center justify-between">
      ...
      <nav className="hidden md:block">
        <ul className="flex space-x-8">
          <li><button onClick={() => scrollToSection('home')} className="text-white opacity-80 hover:opacity-100 transition-all duration-200 py-2 px-3 rounded-lg hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-md">Home</button></li>
          ...
          <li><button onClick={() => scrollToSection('distributor')} className="text-white opacity-80 hover:opacity-100 transition-all duration-200 py-2 px-3 rounded-lg hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-md">Become a Distributor</button></li>
          <li><button onClick={() => scrollToSection('services')} className="text-white opacity-80 hover:opacity-100 transition-all duration-200 py-2 px-3 rounded-lg hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-md">Services</button></li>
          <li><button onClick={() => scrollToSection('contact')} className="text-white opacity-80 hover:opacity-100 transition-all duration-200 py-2 px-3 rounded-lg hover:bg-white/10 hover:-translate-y-0.5 hover:shadow-md">Contact Us</button></li>
        </ul>
      </nav>
      {/* Mobile Menu Button */}
